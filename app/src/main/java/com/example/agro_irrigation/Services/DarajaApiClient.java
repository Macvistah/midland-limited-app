...
import com.example.agro_irrigation.Interceptor.AccessTokenInterceptor;
import com.example.agro_irrigation.Interceptor.AuthInterceptor;
...
import static com.example.agro_irrigation.Constants.CONNECT_TIMEOUT;
import static com.example.agro_irrigation.Constants.MPESA_BASE_URL;
import static com.example.agro_irrigation.Constants.READ_TIMEOUT;
import static com.example.agro_irrigation.Constants.WRITE_TIMEOUT;
...
public class DarajaApiClient {
    ...
    private Retrofit getRestAdapter() {
        ...
        builder.baseUrl(MPESA_BASE_URL);
